...
<head>
    ...
    <script src="/scripts/biz/organization/prework/prework.evaluation.manage.js?v=20190508"></script>
</head>
<body>
<!-- 标题栏 开始 -->
<div class="c_header e_show">
    <div class="back" ontap="$.redirect.closeCurrentPage();">岗前考评管理</div>
    <div class="fn">
