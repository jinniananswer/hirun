...
<head>
    ...
    <script src="/scripts/biz/organization/personnel/contacts.js"></script>
</head>
<body>
<!-- 标题栏 开始 -->
                ...
                <li>
                    <div class="value">
                        <span class="e_mix">
                            ...
                            <button type="button" class="e_button-blue" ontap="$.contact.query();"><span class="e_ico-search"></span><span>查询</span></button>
                        </span>
                    </div>
                </li>
            </ul>
