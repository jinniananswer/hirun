...
<head>
    ...
    <script src="/scripts/biz/organization/personnel/query.employee.js"></script>
</head>
<body>
<div class="c_header">
    <div class="back" ontap="$.redirect.closeCurrentPage();">员工档案查询</div>
    <div class="fn">
