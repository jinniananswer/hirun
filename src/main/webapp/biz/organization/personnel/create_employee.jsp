...
<head>
    ...
    <script src="/scripts/biz/organization/personnel/create.employee.js?v=20180807180000"></script>
</head>
<body>
<!-- 标题栏 开始 -->
            ...
            <div class="c_list c_list-form">
                <ul id="submitArea">
                    ...
                    <li class="link required" ontap="$('#CITY_TEXT').focus();$('#CITY_TEXT').blur();showPopup('UI-popup','UI-CITY')">
                        ...
                        <div class="value">
                            <input type="text" id="CITY_TEXT" name="CITY_TEXT" nullable="no" readonly="true" desc="责任店面" />
                            <input type="hidden" id="CITY" name="CITY" nullable="no" desc="归属门店" />
                        </div>
                        <div class="more"></div>
                    </li>
