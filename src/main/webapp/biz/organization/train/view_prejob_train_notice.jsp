    ...
    <div class="l_padding">
        <div class="c_article">
            ...
            <div class="content content-auto">
                ...
                六、学员须带物品
                <br/>
                （一）学习所需物品：五门通用资料、笔记本、签字笔；
                <br/>
                （二）生活所需物品：衣物（女生禁止穿短裤、吊带；男生禁止穿背心）、运动鞋（晨跑用）、拖鞋（宿舍洗澡用，禁止穿拖鞋上课）、餐具、水杯及个人日常生活用品。
                <br/>
                七、培训期间应遵守的日常管理细则：
                <br/>
                <span class="e_strong">（一）军纪纪律 :6:30前所有学员到达操场，并集合、整队完毕，听从教官指挥。</span>
                <br/>
                1、迟到的，迟到一次日常行为考核项目扣1分,男生罚10个俯卧撑，女生罚10个下蹲；迟到两次扣2分，男生罚20个俯卧撑，女生罚20个下蹲；迟到三次扣3分，男生罚30个俯卧撑，女生罚30个下蹲；迟到四次记0分。
                <br/>
                2、无故缺席晨练的，出现一次扣2分，二次记零分；不听从教官指挥者，日常行为考核项目记0分。
                <br/>
                ...
                <br/>
                5、无故缺席培训，根据各分公司《员工奖惩条例》的第二章纪律管理2.3.1缺席公司/部门培训、会议的，扣5分（人民币50元）；或报到当天，如有迟到者，扣2分(人民币20元)，并全集团通报批评；
                <br/>
