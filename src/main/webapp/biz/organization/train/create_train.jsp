...
<head>
    ...
    <script src="/scripts/biz/organization/train/create.train.js?v=20181214"></script>
</head>
<body>
        ...
        <div class="c_list c_list-col-1 c_list-fixWrapSpace c_list-form">
            <ul id="trainArea">
                ...
                <li class="link required" ontap="$('#CHARGE_EMPLOYEE_NAME').focus();$('#CHARGE_EMPLOYEE_NAME').blur();showPopup('UI-popup','UI-EMPLOYEE')">
                    ...
                    <div class="value">
                        <input type="text" id="CHARGE_EMPLOYEE_NAME" name="CHARGE_EMPLOYEE_NAME" nullable="yes" readonly="true" desc="班主任" />
                        <input type="hidden" id="CHARGE_EMPLOYEE_ID" name="CHARGE_EMPLOYEE_ID" nullable="yes" desc="班主任" />
                    </div>
                    <div class="more"></div>
                </li>
                <li class="link">
