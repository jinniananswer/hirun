...
<head>
    ...
    <script src="scripts/biz/cust/cust.action.additional.entry.js?a=1"></script>
</head>
<body>
<jsp:include page="/header.jsp">
    <jsp:param value="客户动作补录" name="headerName"/>
</jsp:include>
                ...
                <div class="c_popupItem" id="CustQueryCondPopupItem">
                    ...
                    <div class="c_scroll c_scroll-float c_scroll-header l_padding">
                        <div class="c_list c_list_form c_list-line" id="queryCustParamForm">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="value">
                                        <span class="e_mix" ontap="custActionAdditionalEntry.selectHouses(this)">
                                ...
                                <li>
                                    ...
                                    <div class="value">
                                        <span class="e_mix" ontap="custActionAdditionalEntry.selectCounselor(this)">
                        ...
                        <div class="c_submit c_submit-full">
                            <button type="button" class="e_button-l e_button-green" ontap="custActionAdditionalEntry.queryCustList4Cond(this)">查询</button>
                        </div>
                    </div>
                </div>
                <div class="c_popupItem" id="CustActionSelectPopupItem">
                    <div class="c_header">
                        <div class="back" ontap="backPopup(this)">选择补录的动作</div>
                    </div>
                    <div class="l_padding">
                        ...
                        <div class="c_list c_list_form c_list-line" id="changeForm">
                            <ul>
                                <li class="link required">
                                    <div class="label">家装顾问</div>
                                    <div class="value">
                                        <span class="e_mix" ontap="custActionSelectPopup.selectCounselor(this)">
                        ...
                        <div class="e_space"></div>
                        <div class="c_submit c_submit-full">
                            <button type="button" class="e_button-l e_button-green" ontap="custActionSelectPopup.confirm(this)">确定</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <ul>
            ...
            <li id="CUST_ID_{{cust.CUST_ID}}">
                ...
                <div class="link side" cust_id="{{cust.CUST_ID}}" cust_name="{{cust.CUST_NAME}}"
                     ontap="custActionAdditionalEntry.showCustDetail(this)">
                    查看详情
                </div>
                <div class="link side" cust_id="{{cust.CUST_ID}}" cust_name="{{cust.CUST_NAME}}"
                     ontap="custActionAdditionalEntry.clickCustCounselorChange(this)">
                    动作补录
                </div>
            </li>
            {{/each}}
...
<script id="action_list_template" rel_id = "action_list" type="text/html">
    {{each ACTION_LIST action idx}}
    <li class="link" action_code="{{action.ACTION_CODE}}">
...
<script type="text/javascript">
    Wade.setRatio();
    custActionAdditionalEntry.init();
</script>
</body>
</html>