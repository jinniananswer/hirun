...
<head>
    ...
    <script src="/scripts/biz/customerservice/citycabin/create.citycabin.js?v=20190412"></script>
</head>
<body>
<!-- 标题栏 开始 -->
...
<div class="c_scroll c_scroll-float c_scroll-header">
    <div class="l_padding">
        ...
        <div class="c_submit c_submit-full">
            <button type="button" class="e_button-r e_button-l e_button-green" ontap="$.createCityCabin.submit()">提交</button>
        </div>
        <!-- 提交 结束 -->
        <div class="c_space"></div>
