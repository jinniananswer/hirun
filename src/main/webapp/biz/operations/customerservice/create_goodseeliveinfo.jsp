        ...
        <div class="c_list c_list-col-1 c_list-fixWrapSpace c_list-form">
            <ul >
               ...
               <li class="link required">
                       ...
                       <div class="value">
                             <input type="text" id="CONTACT" name="CONTACT" placeholder="请填写正确的电话号码" nullable="no" desc="电话号码" onblur="$.goodseelive.checkCustomerByMobile(this);"/>
                       </div>
                </li>
                <li class="link required">
                        ...
                        <div class="l_padding">
                         ...
                         <div class="c_space-3"></div>
                                <div class="l_bottom" style="display:none">
                                    <div class="c_submit c_submit-full">
                                        <button type="confirmButton" id="" name="confirmButton" ontap="$.goodseelive.confirmSelectHobby();" class="e_button-l e_button-green">确定</button>
                                    </div>
                                </div>
                    </div>
                </div>
