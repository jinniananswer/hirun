...
<head>
    ...
    <script src="/scripts/biz/customerservice/change.goodseeliveinfo.js?v=20190833"></script>
</head>
<body>
<div class="c_header e_show">
    <div class="back" ontap="$.redirect.closeCurrentPage();">客户需求信息修改</div>
    <div class="fn">
        ...
        <div class="c_list c_list-col-1 c_list-fixWrapSpace c_list-form">
            <ul >
               ...
               <li class="link required">
                       ...
                       <div class="value">
                             <input type="text" id="CONTACT" name="CONTACT" placeholder="请填写正确的电话号码" nullable="no" desc="电话号码" disabled/>
                       </div>
                </li>
                <li class="link required">
                    <div class="label re">客户姓名</div>
                    <div class="value">
                        <input type="text" id="NAME" name="NAME" placeholder="请输入客户姓名" nullable="no"  desc="客户姓名" disabled/>
                    </div>
                </li>
               ...
               <li class="link required">
                                 ...
                                 <div class="value">
                                     <input type="text" id="houseName" name="houseName" readonly="true" placeholder="" nullable="yes" desc="楼盘" />
                                     <input type="hidden" id="house_id" name="house_id" placeholder="" nullable="yes" desc="" />
                                 </div>
                                 <div class="more"></div>
               </li>
               <li class="link ">
               ...
               <li class="link required">
                                ...
                                <div class="value">
                                    <input type="text" id="AREA" name="AREA" placeholder="" nullable="yes" desc="面积" />
                                </div>
                </li>
               <li class="link">
                ...
                <div class="c_list c_list-col-1 c_list-fixWrapSpace c_list-form">
                    <ul id="LIFESHAPEAREA">
                        ...
                        <li class="link ">
                                 ...
                                 <div class="value">
                                     <input type="text" id="marketing_name" name="marketing_name" placeholder="" nullable="yes" disabled />
                                 </div>
                        </li>
                        <li class="link " >
                                 ...
                                 <div class="value">
                                      <span class="e_mix">
                                           <input type="text" id="marketing_time" name="marketing_time" datatype="date" nullable="yes" disabled />
                        ...
                        <li class="link " >
                                 ...
                                 <div class="value">
                                      <span class="e_mix">
                                           <input type="text" id="consult_time" name="consult_time" datatype="date" nullable="yes" disabled />
                                           <span class="e_ico-date"></span>
                                      </span>
                                 </div>
                        </li>
                        <li class="link " >
                                 ...
                                 <div class="value">
                                      <span class="e_mix">
                                           <input type="text" id="phone_consult_time" name="phone_consult_time" datatype="date" nullable="yes" disabled />
                                           <span class="e_ico-date"></span>
                                      </span>
                                 </div>
                        </li>
                        ...
                        <div class="c_list c_list-col-1 c_list-fixWrapSpace c_list-form">
                            <ul id="">
                                 <li class="link required" >
                                         ...
                                         <div class="value">
                                             <input type="text" id="DESIGNER_WORKS" name="DESIGNER_WORKS" placeholder="" nullable="yes" desc="看中设计师的作品" />
                                         </div>
                                 </li>
                                 <li class="link required" >
                                         <div class="label">木制品意向</div>
                                         <div class="value">
                                             <input type="text" id="WOOD_WISH" name="WOOD_WISH" placeholder="" nullable="yes" desc="木制品意向" />
                                         </div>
                                 </li>
                                 <li class="link ">
                        ...
                        <div class="l_padding">
                                          ...
                                          <li>
                                               <div class="value">
                                                    <span class="e_mix">
                                                         ...
                                                         <button type="button" class="e_button-blue" ontap="$.changegoodseeliveinfo.searchHouse();"><span class="e_ico-search"></span><span>查询</span></button>
                                                     </span>
                                               </div>
                                          </li>
                                    </ul>
                         ...
                         <div class="c_space-3"></div>
                                <div class="l_bottom" style="display:none">
                                    <div class="c_submit c_submit-full">
                                        <button type="confirmButton" id="" name="confirmButton" ontap="$.changegoodseeliveinfo.confirmSelectHobby();" class="e_button-l e_button-green">确定</button>
                                    </div>
                                </div>
                    </div>
                </div>
                    ...
                    <div class="c_scroll">
                        <div class="l_padding">
                            <div class="c_box">
                                ...
                                <div class="l_bottom" >
                                    <div class="c_submit c_submit-full">
                                        <button type="button" id="confirmCustButton" name="confirmCustButton" ontap="$.changegoodseeliveinfo.transCustomer();" class="e_button-l e_button-green">转成我的客户</button>
                                        <button type="button" id="continueSaveButton" name="continueSaveButton" ontap="$.changegoodseeliveinfo.continueSave();" class="e_button-l e_button-green">继续新增</button>
                                    </div>
                                </div>
                            </div>
                        </div>
