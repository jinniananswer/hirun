...
<head>
    ...
    <script src="/scripts/biz/customerservice/change.goodseeliveinfo.js?v=202001020"></script>
</head>
<body>
...
<div class="c_scroll c_scroll-float c_scroll-header c_scroll-submit">
    ...
    <div class="l_padding" id="allSubmitArea">
        ...
        <input type="hidden" id="mergeProjectId" name="mergeProjectId"/>
        ...
        <div class="c_list c_list-col-1 c_list-fixWrapSpace c_list-form">
            <ul >
               ...
               <li class="link required">
                       ...
                       <div class="value">
                             <input type="text" id="CONTACT" name="CONTACT" placeholder="请填写正确的电话号码" nullable="no" desc="电话号码" onblur="$.changegoodseeliveinfo.checkCustomerByMobile(this);"/>
                       </div>
                </li>
                <li class="link required">
               ...
               <li class="link required" ontap="$('#houseName').focus();$('#houseName').blur();showPopup('UI-popup','UI-HOUSELIST');">
                                 ...
                                 <div class="value">
                                     <input type="text" id="houseName" name="houseName" placeholder="" nullable="yes" desc="楼盘" readonly />
               ...
               <li class="link">
                                <div class="label">装修地址</div>
                                <div class="value">
                                    <input type="text" id="houseAddress" name="houseAddress" placeholder="请填写楼盘地址、栋号" readonly nullable="yes" desc="装修地点" />
                                </div>
               </li>
               <li class="link required">
                ...
                <div class="c_list c_list-col-1 c_list-fixWrapSpace c_list-form">
                    <ul id="LIFESHAPEAREA">
                        ...
                        <li class="link required" >
                                 ...
                                 <div class="value">
                                      <span class="e_mix">
                                           <input type="text" id="consult_time" name="consult_time" datatype="date" nullable="no" />
                                           <span class="e_ico-date"></span>
                                      </span>
                                 </div>
                        </li>
<!--
                        <li class="link " >
                                 ...
                                 <div class="value">
                                      <span class="e_mix">
                                           <input type="text" id="phone_consult_time" name="phone_consult_time" datatype="date" nullable="yes" />
                                           <span class="e_ico-date"></span>
                                      </span>
                                 </div>
                        </li>
                        ...
                        <div class="c_list c_list-col-1 c_list-fixWrapSpace c_list-form">
                            <ul id="">
                                 <li class="link required" >
                                         ...
                                         <div class="value">
                                             <input type="text" id="DESIGNER_OPUS" name="DESIGNER_OPUS" placeholder="" nullable="yes" desc="看中设计师的作品" />
                                         </div>
                                 </li>
                                 <li class="link required" >
                                         <div class="label">木制品意向</div>
                                         <div class="value">
                                             <input type="text" id="WOOD_INTENTION" name="WOOD_INTENTION" placeholder="" nullable="yes" desc="木制品意向" />
                                         </div>
                                 </li>
                                 <li class="link ">
            ...
            <div class="c_popupGroup">
                ...
                <div class="c_popupItem" id="UI-CUSTOMERLIST">
                    ...
                    <div class="c_scroll">
                     ...
                     <div class="l_bottom" >
                           <div class="c_submit c_submit-full">
                                 <button type="button" id="confirmCustButton" name="confirmCustButton" ontap="$.changegoodseeliveinfo.transCustomer();" class="e_button-l e_button-green">合并</button>
