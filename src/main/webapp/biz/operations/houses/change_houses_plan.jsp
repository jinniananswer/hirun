...
<head>
    ...
    <script src="/scripts/biz/houses/change.houses.plan.js"></script>
</head>
<body>
<!-- 标题栏 开始 -->
<div class="c_header e_show">
    <div class="back" ontap="back();">变更楼盘规划</div>
</div>
<!-- 标题栏 结束 -->
<!-- 滚动（替换为 java 组件） 开始 -->
            ...
            <div class="c_list c_list-form">
                <ul id="submitArea">
                    ...
                    <li class="link">
                        ...
                        <div class="value"><span class="e_mix" ontap="$.housesPlan.initCounselor();showPopup('UI-popup','UI-popup-query');">
