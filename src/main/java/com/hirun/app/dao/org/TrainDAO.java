...
public class TrainDAO extends GenericDAO {
    ...
    public RecordSet queryPreworkSignList(String trainId, String orgs) throws Exception {
        ...
        StringBuilder sql = new StringBuilder();
        sql.append("select a.train_id, a.employee_id,a.status, b.name, b.identity_no, b.sex,b.major, b.school, b.education_level,b.certificate_no, date_format(b.in_date, '%Y-%m-%d') in_date, c.org_id, c.job_role, d.name org_name, e.name enterprise_name, f.type, f.item,f.in_canteen, g.mobile_no, v.view_id ");
