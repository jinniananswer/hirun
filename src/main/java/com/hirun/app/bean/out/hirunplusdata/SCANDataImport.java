 ...
 */
public class SCANDataImport {

    private static String host = "www.hi-run.net";
    private static String path = "/api/scans";
    ...
    public static void dataImport(String start, String end) throws Exception {
        ...
        for(int i = 0, size = jsonDataList.size(); i < size; i++) {
            ...
            //openId,String staffId, String addTime
            if(OutBean.isExistData4Scan(jsonData.getString("openid"), jsonData.getString("staff_id"), jsonData.getString("add_time"))) {
                //如果已经存在该数据了，则过滤掉
                continue;
            }
        ...
        dao.insertBatch("out_hirunplus_scan",dbList);
