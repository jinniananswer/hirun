...
public class PlanRuleProcess {
    ...
    public static void planEntryInitCheck(String executorId, String planDate) throws Exception {
        ...
        if(planEntity != null) {
            throw new GenericException("-1", "您已经录过【" + planDate + "】的计划了");
